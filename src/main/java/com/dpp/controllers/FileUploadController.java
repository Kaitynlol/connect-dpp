...
import com.dpp.storage.StorageFileNotFoundException;
...
public class FileUploadController {
  ...
  public String handleFileUpload(@RequestParam("file") MultipartFile file,
      RedirectAttributes redirectAttributes) throws ValidationException {
  ...
  public ResponseEntity<?> handleStorageFileNotFound(ValidationException exc) {
